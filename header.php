        ...
        <div class="wow fadeInRight d-flex">
            <div class="de-marquee-list">
                <div class="d-item">
                    ...
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                    <span class="d-item-txt">Sportscar</span>
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                    <span class="d-item-txt">Van</span>
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                    <span class="d-item-txt">Economy</span>
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                    <span class="d-item-txt">Compact</span>
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                    <span class="d-item-txt">Midsize</span>
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                    <span class="d-item-txt">Full Size</span>
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                    <span class="d-item-txt">Luxury</span>
                    <span class="d-item-display"><i class="d-item-dot"></i></span>
                </div>
            </div>
        </div>
                ...
                <div class="de-flex sm-pt10">
                    ...
                    <div class="de-flex-col header-col-mid">
                        <ul id="mainmenu">
                            ...
                            <li><a class="menu-item" href="cars-list.php">Car Fleet</a></li>
                            <li><a class="menu-item" href="about.php">About Us</a></li>
                            <li><a class="menu-item" href="contact_us.php">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="de-flex-col">
